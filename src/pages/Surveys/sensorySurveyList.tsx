...
const surveyData = [
  { id: 1, date: '2024-01-15', surveyName: 'Coffee Taste Test Q1', fromDate: '2024-01-01', toDate: '2024-01-31' },
  { id: 2, date: '2024-01-20', surveyName: 'Snack Preference Survey', fromDate: '2024-01-15', toDate: '2024-02-15' },
  { id: 3, date: '2024-02-01', surveyName: 'Beverage Sensory Analysis', fromDate: '2024-02-01', toDate: '2024-02-28' },
  { id: 4, date: '2024-02-10', surveyName: 'Dairy Product Evaluation', fromDate: '2024-02-10', toDate: '2024-03-10' },
  { id: 5, date: '2024-02-15', surveyName: 'Bakery Items Assessment', fromDate: '2024-02-15', toDate: '2024-03-15' },
  { id: 6, date: '2024-03-01', surveyName: 'Frozen Foods Survey', fromDate: '2024-03-01', toDate: '2024-03-31' },
  { id: 7, date: '2024-03-10', surveyName: 'Chocolate Taste Profile', fromDate: '2024-03-10', toDate: '2024-04-10' },
  { id: 8, date: '2024-03-20', surveyName: 'Organic Products Review', fromDate: '2024-03-20', toDate: '2024-04-20' },
];
  ...
  return (
    <div className="space-y-6">
      <div className="flex flex-col sm:flex-row sm:items-center sm:justify-between gap-4 px-6 pl-6 pb-0 pt-6">
        <div>
          <h1 className="text-2xl font-bold text-[var(--text-primary)]">Sensory Survey</h1>
          <p className="text-[var(--text-secondary)] mt-1">Manage sensory survey data</p>
        </div>
