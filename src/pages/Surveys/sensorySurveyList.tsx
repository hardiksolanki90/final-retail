...
export function SensorySurveyList() {
  ...
  const { surveys, total, isLoading, createMutation, bulkAction } = useSensorySurveys(currentPage);
  const { customers, merchandisers, products, isLoading: optionsLoading } = useSurveyFormOptions();
  ...
  const [columns, setColumns] = useState<Column[]>([
    ...
    { key: 'overallRating', label: 'Overall Rating', visible: true },
  ...
  const handleAddSubmit = async (data: SensorySurveyFormData) => {
