...
export function AreaList() {
  ...
  const [columns, setColumns] = useState<Column[]>([
    { key: 'areaCode', label: 'Area Code', visible: true },
  ...
  const isAreaCodeVisible = isColumnVisible('areaCode');
  const isAreaNameVisible = isColumnVisible('areaName');
  const isNodeLevelVisible = isColumnVisible('nodeLevel');
  const isStatusVisible = isColumnVisible('status');
  const visibleColCount =
    2 + (isAreaCodeVisible ? 1 : 0) + (isAreaNameVisible ? 1 : 0) + (isNodeLevelVisible ? 1 : 0) + (isStatusVisible ? 1 : 0);
