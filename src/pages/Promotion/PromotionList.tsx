...
const promotionsData = [
  { id: 1, code: 'PROMO001', name: 'Summer Sale', type: 'Percentage', discount: '20%', startDate: '2024-06-01', endDate: '2024-08-31', status: 'Active' },
  { id: 2, code: 'PROMO002', name: 'Buy 2 Get 1', type: 'Bundle', discount: '33%', startDate: '2024-05-15', endDate: '2024-06-15', status: 'Expired' },
  { id: 3, code: 'PROMO003', name: 'Flash Deal', type: 'Fixed', discount: '$10', startDate: '2024-07-01', endDate: '2024-07-03', status: 'Active' },
  { id: 4, code: 'PROMO004', name: 'Clearance', type: 'Percentage', discount: '50%', startDate: '2024-07-15', endDate: '2024-07-31', status: 'Scheduled' },
  { id: 5, code: 'PROMO005', name: 'Loyalty Bonus', type: 'Points', discount: '2x Points', startDate: '2024-01-01', endDate: '2024-12-31', status: 'Active' },
  { id: 6, code: 'PROMO006', name: 'Weekend Special', type: 'Percentage', discount: '15%', startDate: '2024-07-06', endDate: '2024-07-07', status: 'Active' },
  { id: 7, code: 'PROMO007', name: 'New Customer', type: 'Fixed', discount: '$25', startDate: '2024-01-01', endDate: '2024-12-31', status: 'Active' },
  { id: 8, code: 'PROMO008', name: 'Holiday Sale', type: 'Percentage', discount: '30%', startDate: '2024-12-20', endDate: '2024-12-31', status: 'Scheduled' },
  { id: 9, code: 'PROMO009', name: 'Volume Discount', type: 'Tiered', discount: 'Up to 25%', startDate: '2024-06-01', endDate: '2024-09-30', status: 'Active' },
  { id: 10, code: 'PROMO010', name: 'Early Bird', type: 'Percentage', discount: '10%', startDate: '2024-04-01', endDate: '2024-04-30', status: 'Expired' },
];
...
export function PromotionList() {
  ...
  const [filterDraft, setFilterDraft] = useState({ code: '', name: '', type: '', discount: '', startDate: '', endDate: '' });
  const [appliedFilter, setAppliedFilter] = useState({ code: '', name: '', type: '', discount: '', startDate: '', endDate: '' });
  ...
  const totalPages = Math.ceil(promotionsData.length / rowsPerPage);
  const startIndex = (currentPage - 1) * rowsPerPage;
  const endIndex = startIndex + rowsPerPage;

  // Apply filters
  const filteredData = promotionsData.filter(c =>
    ...
    (!appliedFilter.discount || String(c.discount ?? '').toLowerCase().includes(appliedFilter.discount.toLowerCase())) &&
  ...
  const handleExportSubmit = () => {
    console.log('Exporting promotions...', { type: exportType, fromDate: exportFromDate, toDate: exportToDate, format: exportFormat });
  ...
  return (
    <div className="space-y-6">
      <div className="flex flex-col sm:flex-row sm:items-center sm:justify-between gap-4 px-6 pl-6 pb-0 pt-6">
        <div>
          <h1 className="text-2xl font-bold text-[var(--text-primary)]">Promotions</h1>
          <p className="text-[var(--text-secondary)] mt-1">Manage promotional campaigns</p>
        </div>
        ...
        <div className="mx-6 mb-2 bg-[var(--bg-card)] border border-[var(--border-color)] rounded-xl px-5 py-4 shadow-sm">
          <div className="flex flex-wrap items-end gap-3">
            ...
            <div className="flex items-end gap-2 pb-0.5">
              ...
              <button
                onClick={() => {
                  const empty = { code: '', name: '', type: '', discount: '', startDate: '', endDate: '' };
      ...
      <div className="bg-[var(--bg-card)] rounded-xl border border-[var(--border-color)] overflow-hidden transition-theme">
        ...
        <Pagination currentPage={currentPage} totalPages={totalPages} total={promotionsData.length} perPage={rowsPerPage} onPageChange={setCurrentPage} onPerPageChange={setRowsPerPage} />
      </div>
        ...
        <div className="fixed inset-0 z-50 flex items-center justify-center">
          ...
          <div className="relative bg-[var(--bg-card)] rounded-lg shadow-xl w-full max-w-lg mx-4">
            <div className="flex items-center justify-between px-6 py-4 border-b border-[var(--border-color)]">
              <h2 className="text-xl font-semibold text-[var(--text-primary)]">Export Promotions</h2>
            ...
            <div className="px-6 py-4 space-y-6">
              <p className="text-[var(--text-secondary)]">Export promotion data in CSV or XLS format.</p>
              ...
              <div className="space-y-3">
                <label className="flex items-center gap-3 cursor-pointer">
                  ...
                  <span className="text-[var(--text-primary)] font-medium">All Promotions</span>
                </label>
                <label className="flex items-center gap-3 cursor-pointer">
